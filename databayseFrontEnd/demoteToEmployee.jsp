...
<head>
  ...
  function DemoteButton_onclick()
  {
    if(document.getElementById("demoteToEmployee-input").value != "") {
        document.getElementById("demoteToEmployee-form").submit();
    }
  }
  </script>
</head>
...
<%
    ...
    String get_id = request.getParameter("demoteToEmployee-input");
