...
<form name="get_rep-form" method="post" action="getRepSales.jsp">
        ...
        <form name="promoteToManager-form" method="post" action="getRepSales.jsp">
        <div class ="form-group col-lg-6 form-large col-lg-offset-2">
          <label for="promoteToManager-label">Promote to Manager</label>
          <input name="promoteToManager-input" id="repId-input" type="text" class="form-control col-lg-offset-1" placeholder="SSN of Person to Promote">
        </div>
