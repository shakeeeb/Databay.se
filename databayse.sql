...
CREATE PROCEDURE addAuction(IN seller_id CHAR(32), IN item_id INTEGER, IN employee_id INTEGER, IN opening_bid DECIMAL(8,2) IN reserve DECIMAL(8,2))
BEGIN
insert into DATABAYSE.Auction(SellerID, ItemID, EmployeeID, OpeningBid, OpeningDate,
  OpeningTime, ClosingDate, ClosingTime, Reserve, Increment)
  values(Lower(seller_id), item_id, employee_id, opening_bid, start_date, start_time,
  closing_date, closing_time, reserve, increment
	);
End
$$*/
